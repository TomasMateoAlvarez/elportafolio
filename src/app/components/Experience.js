                ...
                <div className="space-y-8">
                  <div className="bg-gray-50 rounded-xl p-6 hover:shadow-lg transition-all duration-300 border-l-4 border-blue-600">
                    <div className="flex justify-between items-start mb-3">
                      <h4 className="text-xl font-semibold text-gray-900">SAP IBP Consultant</h4>
                      <span className="bg-green-100 text-green-800 text-xs font-semibold px-2.5 py-0.5 rounded">Current</span>
                    </div>
                    <p className="text-blue-600 font-medium mb-2">2024 - Present • Montevideo, Uruguay</p>
                    <p className="text-gray-600 leading-relaxed">
                      Provided technical support for customer systems and software. Responded to user inquiries,
                      troubleshooting and resolving complex issues with enterprise solutions.
                    </p>
                  </div>

                  <div className="bg-gray-50 rounded-xl p-6 hover:shadow-lg transition-all duration-300 border-l-4 border-blue-600">
                    <div className="flex justify-between items-start mb-3">
                      <h4 className="text-xl font-semibold text-gray-900">Network Admin & IT Support</h4>
                      <span className="bg-green-100 text-green-800 text-xs font-semibold px-2.5 py-0.5 rounded">Current</span>
                    </div>
                    <p className="text-blue-600 font-medium mb-2">2024 - Present • Maldonado, Uruguay</p>
                    <p className="text-gray-600 leading-relaxed">
                      Managed network infrastructure and provided comprehensive IT support.
                      Maintained system security and optimized performance for organizational efficiency.
                    </p>
                  </div>

                  <div className="bg-gray-50 rounded-xl p-6 hover:shadow-lg transition-all duration-300 border-l-4 border-gray-300">
                    <h4 className="text-xl font-semibold text-gray-900 mb-3">Fraud Preventionist</h4>
                    <p className="text-blue-600 font-medium mb-2">2021 - 2023 • Mercado Libre, Montevideo</p>
                    <p className="text-gray-600 leading-relaxed">
                      Analyzed bank accounts and identified movement patterns, chargebacks, and conducted
                      comprehensive data analysis to prevent fraudulent activities.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div className="bg-blue-50 rounded-xl p-6 hover:shadow-lg transition-all duration-300 border-l-4 border-blue-600">
                    <h4 className="text-xl font-semibold text-gray-900 mb-3">Bachelor's Degree in Computer Sciences</h4>
                    <p className="text-blue-600 font-medium mb-2">2022 - Present • UTEC Uruguay</p>
                    <p className="text-gray-600 leading-relaxed">
                      Comprehensive curriculum focused on software development, databases, testing methodologies,
                      and network architecture.
                    </p>
                  </div>

                  <div className="bg-blue-50 rounded-xl p-6 hover:shadow-lg transition-all duration-300 border-l-4 border-blue-600">
                    <h4 className="text-xl font-semibold text-gray-900 mb-3">React.JS Development Bootcamp</h4>
                    <p className="text-blue-600 font-medium mb-2">2024 • Udemy</p>
                    <p className="text-gray-600 leading-relaxed">
                      Intensive training in modern web development with emphasis on React, Node.js,
                ...
                <div className="mt-8">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-gray-50 rounded-lg p-4 text-center">
                      <div className="text-2xl font-bold text-blue-600">Native</div>
